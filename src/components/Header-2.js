...
const Header = () => {
  ...
  return (
    <nav className="flex justify-between text-black dark:bg-[#201c1c] h-10 z-50 -mt-7 w-full">
      ...
      <div
        className="fixed top-0 right-0 h-full dark:bg-[#201c1c] transform translate-x-full transition-transform duration-300 ease-in-out z-40 md:translate-x-0 md:relative md:w-auto md:flex md:pt-0 lg:mr-8 pt-16 pb-16 sm:p-0"
        id="nav-content"
      >
